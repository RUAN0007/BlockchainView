...
def main():
    ...
    if len(sys.argv) <= 2:
        ...
        print "python aggregate_storage.py [workload_base] [number of nodes]"
        return 1

    workload_base = sys.argv[1]
    node_count = int(sys.argv[2])
    total_bytes = 0
    for i in range(node_count):
        metric_path = "result/{}_across_{}nodes_{}.metrics".format(workload_base, node_count, i)
