...
func (t *OnChainView) RetrieveTxnIdsByView(ctx contractapi.TransactionContextInterface, view_name string) string {
	var err error
	stub := ctx.GetStub()
	viewTxns := []string{}
...
//     view_txns[viewName] = [];
func (t *OnChainView) CreateView(ctx contractapi.TransactionContextInterface, viewName, viewPredicate, mergePeriod string) error {
	stub := ctx.GetStub()
...
func (t *OnChainView) txns_from(ctx contractapi.TransactionContextInterface, view_name string, last_time_str string) ([]string, error) {
	stub := ctx.GetStub()
	viewTxns := []string{}
...
func (t *OnChainView) check_to_merge(ctx contractapi.TransactionContextInterface, view_name string, txnID string) (bool, error) {
	fmt.Println("===========================================")
